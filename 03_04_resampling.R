...
# we will use for simplicity's sake, cross-validation, montecarlo cv and bootstraps even if we're dealing with a dataset 
                                                        #with a data set with a temporal component
