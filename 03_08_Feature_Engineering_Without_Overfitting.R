...
file03 = "lm_date_lag14.RData"
file04 = "lm_date_lag14_hol.RData"
file05 = "boost_date_lag14.RData"
file06 = "glmn_date_lag14_hol.RData"
file07 = "glmn_date_lag14.RData"
file08 = "pls_date_lag14_hol.RData"
file09 = "pls_date_lag14.RData"
file11 = paste0(path0, file01)
file22 = paste0(path0, file02)
file33 = paste0(path0, file03)
file44 = paste0(path0, file04)
file55 = paste0(path0, file05)
file66 = paste0(path0, file06)
file77 = paste0(path0, file07)
file88 = paste0(path0, file08)
file99 = paste0(path0, file09)
load(file11)
load(file22)
load(file33)
load(file44)
...
unique(lm_date_lag14$pred$Resample)
lm_date_lag14$pred$Resample[lm_date_lag14$pred$Resample == "2014-12-08"]
lm_date_lag14$pred$Resample[lm_date_lag14$pred$Resample == "2014-12-22"]
lm_date_lag14$pred$Resample[lm_date_lag14$pred$Resample == "2015-12-07"]
lm_date_lag14$pred$Resample[lm_date_lag14$pred$Resample == "2015-12-21"]
...
lm_new <- lm_date_lag14$pred[,c("pred","obs", "Resample")]
lm_new$Resample <- as.Date(lm_new$Resample)
str(lm_new)

lm_new_00 <- lm_date_lag14_hol$pred[,c("pred","obs", "Resample")]
lm_new_00$Resample <- as.Date(lm_new_00$Resample)
str(lm_new_00)

lm_new_2014 <- lm_new[which(lm_new$Resample > "2014-12-06" & lm_new$Resample < "2015-01-02"), ]
...
lm_new_2014_00 <- lm_new_00[which(lm_new_00$Resample > "2014-12-06" & lm_new_00$Resample < "2015-01-02"), ]
...
lm_new_2015 <- lm_new[which(lm_new$Resample > "2015-12-06" & lm_new$Resample < "2016-01-02"), ]
...
lm_new_2015_00 <- lm_new_00[which(lm_new_00$Resample > "2015-12-06" & lm_new_00$Resample < "2016-01-02"), ]
...
unique(glmn_date_lag14$pred$Resample)
unique(glmn_date_lag14_hol$pred$Resample)

glmn_new <- glmn_date_lag14$pred[,c("pred","obs", "Resample")]
glmn_new$Resample <- as.Date(glmn_new$Resample)
str(glmn_new)

glmn_new_00 <- glmn_date_lag14_hol$pred[,c("pred","obs", "Resample")]
glmn_new_00$Resample <- as.Date(glmn_new_00$Resample)
str(glmn_new_00)

glmn_new_2014 <- glmn_new[which(glmn_new$Resample > "2014-12-06" & glmn_new$Resample < "2015-01-02"), ]
d14 <- unique(glmn_new_2014$Resample)[1]
d14 <- seq(d14, as.Date("2014-12-30"), by="days")
glmn_new_2014 <- glmn_new_2014[1:length(d14),]
glmn_new_2014$Resample <- d14
glmn_new_2014 <- glmn_new_2014[which(glmn_new_2014$Resample >= "2014-12-15" & glmn_new_2014$Resample <= "2014-12-30"), ]
glmn_new_2014 <- merge(glmn_new_2014, df_dec_2014, by = "Resample")
glmn_new_2014 <- merge(glmn_new_2014, date_pred_2014)
names(glmn_new_2014)[names(glmn_new_2014) == 'pred'] <- 'model_original'
glmn_new_2014 <- glmn_new_2014[,c("Resample","day","weekday_end","holiday","obs","model_original")]
head(glmn_new_2014)

glmn_new_2014_00 <- glmn_new_00[which(glmn_new_00$Resample > "2014-12-06" & glmn_new_00$Resample < "2015-01-02"), ]
d14 <- unique(glmn_new_2014_00$Resample)[1]
d14 <- seq(d14, as.Date("2014-12-30"), by="days")
glmn_new_2014_00 <- glmn_new_2014_00[1:length(d14),]
glmn_new_2014_00$Resample <- d14
glmn_new_2014_00 <- glmn_new_2014_00[which(glmn_new_2014_00$Resample >= "2014-12-15" & glmn_new_2014_00$Resample <= "2014-12-30"), ]
names(glmn_new_2014_00)[names(glmn_new_2014_00) == 'pred'] <- 'model_holidays'
glmn_new_2014_01 <- glmn_new_2014_00[,c("Resample", "model_holidays")]
#glmn_new_2014_00 <- merge(glmn_new_2014_00, df_dec_2014, by = "Resample")
glmn_new_2014$obs == glmn_new_2014_01$obs
head(glmn_new_2014_01)

glmn_new_2015 <- glmn_new[which(glmn_new$Resample > "2015-12-06" & glmn_new$Resample < "2016-01-02"), ]
d15 <- unique(glmn_new_2015$Resample)[1]
d15 <- seq(d15, as.Date("2015-12-30"), by="days")
glmn_new_2015 <- glmn_new_2015[1:length(d15),]
glmn_new_2015$Resample <- d15
glmn_new_2015 <- glmn_new_2015[which(glmn_new_2015$Resample >= "2015-12-15" & glmn_new_2015$Resample <= "2015-12-30"), ]
glmn_new_2015 <- merge(glmn_new_2015, df_dec_2015, by = "Resample")
glmn_new_2015 <- merge(glmn_new_2015, date_pred_2015)
names(glmn_new_2015)[names(glmn_new_2015) == 'pred'] <- 'model_original'
glmn_new_2015 <- glmn_new_2015[,c("Resample","day","weekday_end","holiday","obs","model_original")]
head(glmn_new_2015)

glmn_new_2015_00 <- glmn_new_00[which(glmn_new_00$Resample > "2015-12-06" & glmn_new_00$Resample < "2016-01-02"), ]
d15 <- unique(glmn_new_2015_00$Resample)[1]
d15 <- seq(d15, as.Date("2015-12-30"), by="days")
glmn_new_2015_00 <- glmn_new_2015_00[1:length(d15),]
glmn_new_2015_00$Resample <- d15
glmn_new_2015_00 <- glmn_new_2015_00[which(glmn_new_2015_00$Resample >= "2015-12-15" & glmn_new_2015_00$Resample <= "2015-12-30"), ]
names(glmn_new_2015_00)[names(glmn_new_2015_00) == 'pred'] <- 'model_holidays'
glmn_new_2015_01 <- glmn_new_2015_00[,c("Resample", "model_holidays")]
#glmn_new_2015_00 <- merge(glmn_new_2015_00, df_dec_2015, by = "Resample")
glmn_new_2015$obs == glmn_new_2015_01$obs
head(glmn_new_2015_01)

glmn_2014 <- merge(glmn_new_2014,glmn_new_2014_01)
glmn_2015 <- merge(glmn_new_2015,glmn_new_2015_01)
head(glmn_2014)
head(glmn_2015)

glmn_2014_melt <- melt(glmn_2014, id.vars = c('Resample', 'day', 'weekday_end', 'holiday'), variable.name = 'series')
head(glmn_2014_melt)

glmn_2015_melt <- melt(glmn_2015, id.vars = c('Resample', 'day', 'weekday_end', 'holiday'), variable.name = 'series')
head(glmn_2015_melt)


glmn_2014_plot <- ggplot(glmn_2014_melt, aes(Resample,value)) + 
  geom_line(aes(colour = series)) +
  #geom_line(aes(linetype=series)) +
  #scale_linetype_manual(values=c("twodash", "dotted", "solid")) +
  geom_point(aes(shape=weekday_end, colour = day, size=0.2)) +
...
glmn_2015_plot <- ggplot(glmn_2015_melt, aes(Resample,value)) + 
  geom_line(aes(colour = series)) +
  #geom_line(aes(linetype=series)) +
  #scale_linetype_manual(values=c("twodash", "dotted", "solid")) +
  geom_point(aes(shape=weekday_end, colour = day, size=0.2)) +
...
grid.arrange(glmn_2014_plot, glmn_2015_plot, nrow = 2, ncol = 1,
             top = textGrob("2014 (top) & 2015 (bottom)",gp=gpar(fontsize=10, fontface="bold"))
)
#,
#bottom = textGrob("black dots represents the assessment set in each resample",gp=gpar(fontsize=10)))
...
unique(pls_date_lag14$pred$Resample)
unique(pls_date_lag14_hol$pred$Resample)

pls_new <- pls_date_lag14$pred[,c("pred","obs", "Resample")]
pls_new$Resample <- as.Date(pls_new$Resample)
str(pls_new)

pls_new_00 <- pls_date_lag14_hol$pred[,c("pred","obs", "Resample")]
pls_new_00$Resample <- as.Date(pls_new_00$Resample)
str(pls_new_00)

pls_new_2014 <- pls_new[which(pls_new$Resample > "2014-12-06" & pls_new$Resample < "2015-01-02"), ]
d14 <- unique(pls_new_2014$Resample)[1]
d14 <- seq(d14, as.Date("2014-12-30"), by="days")
pls_new_2014 <- pls_new_2014[1:length(d14),]
pls_new_2014$Resample <- d14
pls_new_2014 <- pls_new_2014[which(pls_new_2014$Resample >= "2014-12-15" & pls_new_2014$Resample <= "2014-12-30"), ]
pls_new_2014 <- merge(pls_new_2014, df_dec_2014, by = "Resample")
pls_new_2014 <- merge(pls_new_2014, date_pred_2014)
names(pls_new_2014)[names(pls_new_2014) == 'pred'] <- 'model_original'
pls_new_2014 <- pls_new_2014[,c("Resample","day","weekday_end","holiday","obs","model_original")]
head(pls_new_2014)

pls_new_2014_00 <- pls_new_00[which(pls_new_00$Resample > "2014-12-06" & pls_new_00$Resample < "2015-01-02"), ]
d14 <- unique(pls_new_2014_00$Resample)[1]
d14 <- seq(d14, as.Date("2014-12-30"), by="days")
pls_new_2014_00 <- pls_new_2014_00[1:length(d14),]
pls_new_2014_00$Resample <- d14
pls_new_2014_00 <- pls_new_2014_00[which(pls_new_2014_00$Resample >= "2014-12-15" & pls_new_2014_00$Resample <= "2014-12-30"), ]
names(pls_new_2014_00)[names(pls_new_2014_00) == 'pred'] <- 'model_holidays'
pls_new_2014_01 <- pls_new_2014_00[,c("Resample", "model_holidays")]
#pls_new_2014_00 <- merge(pls_new_2014_00, df_dec_2014, by = "Resample")
pls_new_2014$obs == pls_new_2014_01$obs
head(pls_new_2014_01)

pls_new_2015 <- pls_new[which(pls_new$Resample > "2015-12-06" & pls_new$Resample < "2016-01-02"), ]
d15 <- unique(pls_new_2015$Resample)[1]
d15 <- seq(d15, as.Date("2015-12-30"), by="days")
pls_new_2015 <- pls_new_2015[1:length(d15),]
pls_new_2015$Resample <- d15
pls_new_2015 <- pls_new_2015[which(pls_new_2015$Resample >= "2015-12-15" & pls_new_2015$Resample <= "2015-12-30"), ]
pls_new_2015 <- merge(pls_new_2015, df_dec_2015, by = "Resample")
pls_new_2015 <- merge(pls_new_2015, date_pred_2015)
names(pls_new_2015)[names(pls_new_2015) == 'pred'] <- 'model_original'
pls_new_2015 <- pls_new_2015[,c("Resample","day","weekday_end","holiday","obs","model_original")]
head(pls_new_2015)

pls_new_2015_00 <- pls_new_00[which(pls_new_00$Resample > "2015-12-06" & pls_new_00$Resample < "2016-01-02"), ]
d15 <- unique(pls_new_2015_00$Resample)[1]
d15 <- seq(d15, as.Date("2015-12-30"), by="days")
pls_new_2015_00 <- pls_new_2015_00[1:length(d15),]
pls_new_2015_00$Resample <- d15
pls_new_2015_00 <- pls_new_2015_00[which(pls_new_2015_00$Resample >= "2015-12-15" & pls_new_2015_00$Resample <= "2015-12-30"), ]
names(pls_new_2015_00)[names(pls_new_2015_00) == 'pred'] <- 'model_holidays'
pls_new_2015_01 <- pls_new_2015_00[,c("Resample", "model_holidays")]
#pls_new_2015_00 <- merge(pls_new_2015_00, df_dec_2015, by = "Resample")
pls_new_2015$obs == pls_new_2015_01$obs
head(pls_new_2015_01)

pls_2014 <- merge(pls_new_2014,pls_new_2014_01)
pls_2015 <- merge(pls_new_2015,pls_new_2015_01)
head(pls_2014)
head(pls_2015)

pls_2014_melt <- melt(pls_2014, id.vars = c('Resample', 'day', 'weekday_end', 'holiday'), variable.name = 'series')
head(pls_2014_melt)

pls_2015_melt <- melt(pls_2015, id.vars = c('Resample', 'day', 'weekday_end', 'holiday'), variable.name = 'series')
head(pls_2015_melt)


pls_2014_plot <- ggplot(pls_2014_melt, aes(Resample,value)) + 
  geom_line(aes(colour = series)) +
  #geom_line(aes(linetype=series)) +
  #scale_linetype_manual(values=c("twodash", "dotted", "solid")) +
  geom_point(aes(shape=weekday_end, colour = day, size=0.2)) +
...
pls_2015_plot <- ggplot(pls_2015_melt, aes(Resample,value)) + 
  geom_line(aes(colour = series)) +
  #geom_line(aes(linetype=series)) +
  #scale_linetype_manual(values=c("twodash", "dotted", "solid")) +
  geom_point(aes(shape=weekday_end, colour = day, size=0.2)) +
...
grid.arrange(pls_2014_plot, pls_2015_plot, nrow = 2, ncol = 1,
             top = textGrob("2014 (top) & 2015 (bottom)",gp=gpar(fontsize=10, fontface="bold"))
             )
#,
#bottom = textGrob("black dots represents the assessment set in each resample",gp=gpar(fontsize=10)))
...
svm_new_00$Resample <- as.Date(svm_new_00$Resample)
str(svm_new_00)

svm_new_2014 <- svm_new[which(svm_new$Resample > "2014-12-06" & svm_new$Resample < "2015-01-02"), ]
...
svm_new_2014_00 <- svm_new_00[which(svm_new_00$Resample > "2014-12-06" & svm_new_00$Resample < "2015-01-02"), ]
...
svm_new_2015 <- svm_new[which(svm_new$Resample > "2015-12-06" & svm_new$Resample < "2016-01-02"), ]
...
svm_new_2015_00 <- svm_new_00[which(svm_new_00$Resample > "2015-12-06" & svm_new_00$Resample < "2016-01-02"), ]
